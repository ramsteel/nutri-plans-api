...
// GetRecommendations provides a mock function with given fields: ctx, uid
func (_m *MockRecommendationRepository) GetRecommendations(ctx context.Context, uid uuid.UUID) (*[]entities.Recommendation, error) {
